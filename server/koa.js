...
// API routes
import getTracksRoute from './api/getTracks';
import getPlaylistsRoute from './api/getPlaylists';
import downloadPlaylistTracks from './api/downloadPlaylistTracks';
...
// api routes
app.use(getTracksRoute);
app.use(getPlaylistsRoute);
app.use(downloadPlaylistTracks);
// website routes
app.use(router);
